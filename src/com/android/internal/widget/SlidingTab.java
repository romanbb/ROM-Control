...
public class SlidingTab extends ViewGroup {
    ...
    private static final int R_style_TextAppearance_SlidingTabNormal = 0x1030092;
    private static final int R_style_TextAppearance_SlidingTabIconText = 0x1030095;
    private static final int R_attr_state_active = 0x10100a2;
    private static final int R_style_TextAppearance_SlidingTabActive = 0x1030094;
    private static final int R_drawable_jog_tab_left_generic = 0x108021f;
    private static final int R_drawable_jog_tab_bar_left_generic = 0x108020c;
    private static final int R_drawable_jog_tab_target_gray = 0x108022f;
    private static final int R_drawable_jog_tab_right_generic = 0x1080229;
    private static final int R_drawable_jog_tab_bar_right_generic = 0x1080216;
    ...
    private final ImageView icon;
        ...
        Slider(ViewGroup parent, int tabId, int barId, int targetId) {
            ...
            text.setTextAppearance(parent.getContext(), R_style_TextAppearance_SlidingTabNormal);
        ...
        iconText.setTextAppearance(parent.getContext(), R_style_TextAppearance_SlidingTabIconText);
    ...
    public void setInvisible(){
        ...
        void setState(int state) {
            ...
            if (state == STATE_ACTIVE) {
                final int[] activeState = new int[] {R_attr_state_active};
                ...
                text.setTextAppearance(text.getContext(), R_style_TextAppearance_SlidingTabActive);
            } else {
                text.setTextAppearance(text.getContext(), R_style_TextAppearance_SlidingTabNormal);
            }
            currentState = state;
        }
    ...
    public SlidingTab(Context context, AttributeSet attrs) {
        ...
        mOrientation = a.getInt(0x0, HORIZONTAL);
        a.recycle();
        ...
        mLeftSlider = new Slider(this,
                R_drawable_jog_tab_left_generic,
                R_drawable_jog_tab_bar_left_generic,
                R_drawable_jog_tab_target_gray);
        mRightSlider = new Slider(this,
                R_drawable_jog_tab_right_generic,
                R_drawable_jog_tab_bar_right_generic,
                R_drawable_jog_tab_target_gray);
