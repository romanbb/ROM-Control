...
public class RotarySelector extends View {
    ...
    private boolean mHideArrows=true;
    ...
    private static final int R_drawable_jog_dial_bg = 0x1080202;
    private static final int R_drawable_jog_dial_dimple_dim = 0x1080204;
    private static final int R_drawable_jog_dial_dimple = 0x1080203;
    private static final int R_drawable_jog_dial_bg_rev_down = 0x108045e;
    private static final int R_drawable_jog_dial_bg_rev = 0x108045d;
    private static final int R_drawable_jog_dial_dimple_rev = 0x108045f;
    private static final int R_drawable_jog_dial_dimple_dim_rev = 0x1080460;
    private static final int R_drawable_lense_square_bg = 0x1080461;
    private static final int R_drawable_jog_dial_arrow_long_left_green = 0x10801fa;
    private static final int R_integer_config_lenseTimeLabelOffsetDIP = 0x10e0015;
    private static final int R_integer_config_rotaryMarginBottomDIP = 0x10e0016;
    private static final int R_drawable_jog_dial_arrow_long_right_red = 0x10801fd;
    private static final int R_drawable_jog_dial_arrow_short_down_green = 0x108045a;
    private static final int R_drawable_jog_dial_arrow_short_left_and_right = 0x1080200;
    private static final int R_integer_config_rotaryOuterRadiusDIP = 0x10e0017;
    private static final int R_integer_config_rotaryStrokeWidthDIP = 0x10e0018;
    ...
    public RotarySelector(Context context, AttributeSet attrs) {
        ...
        TypedArray a =
            context.obtainStyledAttributes(attrs, new int[]{0});
        mOrientation = a.getInt(0, HORIZONTAL);
        a.recycle();
        ...
        mBackground = getBitmapFor(R_drawable_jog_dial_bg);
        mDimple = getBitmapFor(R_drawable_jog_dial_dimple);
        mDimpleDim = getBitmapFor(R_drawable_jog_dial_dimple_dim);

        mArrowLongLeft = getBitmapFor(R_drawable_jog_dial_arrow_long_left_green);
        mArrowLongRight = getBitmapFor(R_drawable_jog_dial_arrow_long_right_red);
        mArrowDown = getBitmapFor(R_drawable_jog_dial_arrow_short_down_green);
        mArrowShortLeftAndRight = getBitmapFor(R_drawable_jog_dial_arrow_short_left_and_right);
        ...
        mRotaryOuterRadiusDIP = context.getResources().getInteger(R_integer_config_rotaryOuterRadiusDIP);
        mRotaryStrokeWidthDIP = context.getResources().getInteger(R_integer_config_rotaryStrokeWidthDIP);
        ...
        int marginBottomDIP = context.getResources().getInteger(R_integer_config_rotaryMarginBottomDIP);
        ...
        mDateFormatString = context.getString(R_string_full_wday_month_day_no_year);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mLenseMode){
            if(isHoriz()){
                ...
                int customTimeOffset = getContext().getResources().getInteger(R_integer_config_lenseTimeLabelOffsetDIP);
        ...
        final int rightThresh = super.getRight() + halfdimple;
    ...
    private synchronized void vibrate() {
        ...
        if (hapticsEnabled) {
            ...
            mVibrator.vibrate(VIBRATE_LONG);
        }
    }
    ...
    public void setRevamped(boolean newState){
        if(newState){
            if(mCustomAppDimple)
                mBackground = getBitmapFor(R_drawable_jog_dial_bg_rev_down);
            else
                mBackground = getBitmapFor(R_drawable_jog_dial_bg_rev);
            mDimple = getBitmapFor(R_drawable_jog_dial_dimple_rev);
            mDimpleDim = getBitmapFor(R_drawable_jog_dial_dimple_dim_rev);
        }
    ...
    public void setLenseSquare(boolean newState){
        ...
        if(newState){
            mLenseMode=true;
            mBackground = getBitmapFor(R_drawable_lense_square_bg);
        }
    }
